                ...
                >
                  {img ? (
                    <img
                      ...
                      // The last cards are the ones nearest the viewer on the
                      // first frame, so they are the ones worth the bandwidth
                      // first; the rest can queue behind them.
                      fetchPriority={priority && i >= cards - 5 ? "high" : "auto"}
                      decoding="async"
