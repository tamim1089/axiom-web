    ...
    <div ref={containerRef} className={cn("relative h-[300vh] w-full", className)}>
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <img src={images.topLeft} alt="Top Left" width={1600} height={1100} loading="lazy" decoding="async" className="h-full w-full object-cover" />
          </motion.div>
          ...
          >
            <img src={images.bottomRight} alt="Bottom Right" width={1600} height={1100} loading="lazy" decoding="async" className="h-full w-full object-cover" />
          </motion.div>
          ...
          >
            <img src={images.bottomLeft} alt="Bottom Left" width={1600} height={1100} loading="lazy" decoding="async" className="h-full w-full object-cover" />
          </motion.div>
          ...
          >
            <img src={images.topRight} alt="Top Right (Hero)" width={1600} height={1100} loading="lazy" decoding="async" className="h-full w-full object-cover" />
          </motion.div>
        </div>
      </div>
    </div>
