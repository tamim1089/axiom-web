...
export const FAQ = [
  ...
  },
  {
    ...
    a: 'Axiom itself is free, and there is no subscription, because we pay for no storage and no bandwidth — your files move directly between your browser and Telegram. Your capacity is whatever your Telegram account allows. We will not advertise unlimited storage: individual files are capped by Telegram, and Telegram sets the overall limits, not us.',
  },
  {
